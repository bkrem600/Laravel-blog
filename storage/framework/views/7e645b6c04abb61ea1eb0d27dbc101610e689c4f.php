                    ...
                    <div class="hidden lg:flex justify-between mb-6">
                        ...
                        <div class="space-x-2">
                            <h1 class="px-3 py-1 rounded-full text-gray-600 text-xs uppercase font-semibold"
                                style="font-size: 12px"><?php echo e($post->category->name); ?></h1>
                        </div>
                    </div>
                    ...
                    <?php $__currentLoopData = $post->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="flex bg-gray-100 p-6 rounded-xl border border-gray-200 space-x-4">
                            <div class="flex-shrink-0">
                                <img src="https://i.pravatar.cc/60?u=<?php echo e($comment->user_id); ?>" alt="" width="60"
                                    height="60" class="rounded-xl">
                            </div>
                            <div>
                                <header>
                                    <h3 class="font-bold"><?php echo e($comment->author->name); ?></h3>
...
<?php /**PATH /home/ubuntu/blog1/resources/views/posts/show.blade.php ENDPATH**/ ?>